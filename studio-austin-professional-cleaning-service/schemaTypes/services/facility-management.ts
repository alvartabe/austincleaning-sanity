...
export const facilityManagementService = defineType({
  name: 'facilityManagementService',
  title: 'Facility ManagementService Service',
  type: 'document',
  fields: [
    {
      name: 'pageTitle',
      title: 'Page Title',
      type: 'string',
      description: 'The title of the service page (e.g., "Facility Management Service").',
    },
    {
      name: 'slug',
      title: 'Slug',
