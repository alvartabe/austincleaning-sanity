...
export const wasteManagementService = defineType({
  ...
  fields: [
    {
      ...
      title: 'Page Title',
      type: 'string',
      description: 'The title of the service page (e.g., "Waste Management Services").',
    },
    {
      name: 'slug',
      title: 'Slug',
    ...
    // New field for process steps
    {
      ...
      of: [{ type: 'string' }],
      description:
        'List the process steps (e.g., "Our crew will arrive within the hour...", "Upon quote approval, we begin...", "Depending on the damage, restoration can take days to weeks...").',
    },
    {
      ...
      of: [{ type: 'string' }],
      description:
        'List of services offered (e.g., "Flood and Water Damage Restoration", "Contents Cleaning", "Structural Repair", etc.).',
    },
    {
      name: 'cta',
      ...
      of: [
        {
          ...
          preview: {
            select: { title: 'city', subtitle: 'number' },
          },
        },
      ],
