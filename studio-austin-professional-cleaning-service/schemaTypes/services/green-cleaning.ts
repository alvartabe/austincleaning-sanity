...
export const greenCleaningService = defineType({
  name: 'greenCleaningService',
  title: 'Green Cleaning Service',
  type: 'document',
  fields: [
    {
      name: 'pageTitle',
      title: 'Page Title',
      type: 'string',
      description: 'The title of the service page (e.g., "Green Cleaning Service").',
    },
    {
      name: 'slug',
      title: 'Slug',
